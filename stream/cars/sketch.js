...
function setup() {
  ...
  canvas.parent('sketch');
	...
	cars[cars.length] = new Car(350, -2, cars.length); // x, speed, id
...
Car.prototype.move = function() {
  ...
  // For every car
	for(var i=0;i<cars.length;i++) {
		if(this.id !== i) { // THAT ISN'T ME
      // Check if my hit point (far right, middle) is inside the other car
...
// Inside rectangle check function
